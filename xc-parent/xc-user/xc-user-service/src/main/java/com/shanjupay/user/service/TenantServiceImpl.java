...
import com.xuecheng.common.util.MD5Util;
...
//////////////////////////////////////////租户相关的操作///////////////////////////////////////////////////
    ...
    public String sendMessage(String phone) {
        ...
        HttpEntity<MultiValueMap<String, Object>> entity = new HttpEntity<MultiValueMap<String, Object>>(params, httpHeaders);
        //执行发送
    ...
    public AccountDTO authentication(AuthenticationInfo authenticationInfo) {
        ...
        }else if ("mobile".equals(type)) { //手机号 密码认证
