...
public class UAASecurityUtil {
	...
	public static LoginUser getUser() {
		...
		LoginUser loginUser = (LoginUser) request.getAttribute(LoginUser.REQUEST_USER);
		if(loginUser == null){
