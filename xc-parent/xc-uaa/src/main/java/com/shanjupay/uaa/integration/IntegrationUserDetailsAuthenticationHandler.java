...
import com.shanjupay.uaa.agent.TenantApiAgent;
...
public class IntegrationUserDetailsAuthenticationHandler {
    ...
    private TenantApiAgent tenantService;


    public void setTenantService(TenantApiAgent tenantService) {
    ...
    public UnifiedUserDetails authentication(AuthPrincipal authPrincipal, String credentials) {
        ...
        //%%%%%%%%%%%%%%   上面是login返回的结构 自行格式化查看 需要组装成下面结构   %%%%%%%%%%%%%%%%%%
            ...
            */
        UnifiedUserDetails userDetails = new UnifiedUserDetails(loginInfoDTO.getUsername(), credentials);
